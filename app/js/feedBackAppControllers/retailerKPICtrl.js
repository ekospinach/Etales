var retailerKPICtrl = function($scope, $http, PlayerColor,Label) {
    function GetRequest() {
    ...
    var initPage = function() {
        ...
        specialCategories.forEach(function(single){
            $scope.normalfeedback.f_RetailersValueRotationIndex.forEach(function(singleData){
        ...
        specialCategories.forEach(function(single){
            $scope.normalfeedback.f_RetailersVolumeRotationIndex.forEach(function(singleData){
                if (singleData.period == single) {
                    if (singleData.categoryID == 1) {
                        if (singleData.marketID == 1) {
        ...
        currentCategories.forEach(function(single){
            ...
            $scope.normalfeedback.f_RetailersProfitabilityIndex.forEach(function(singleData){
                if (singleData.period == single) {
            ...
            //Stock Cover
            $scope.normalfeedback.f_RetailersStocksCover.forEach(function(singleData){
                if (singleData.period == single) {
