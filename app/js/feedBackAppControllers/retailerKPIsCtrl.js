var retailerKPIsCtrl=function($scope,$http){
    ...
    var initPage=function(){
        ...
        $http({
            ...
            var rotationIndexSalesValueElecssories=new Array({name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
            var rotationIndexSalesValueHealthBeauties=new Array({name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
            var rotationIndexSalesVolumeElecssories=new Array({name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
            var rotationIndexSalesVolumeHealthBeauties=new Array({name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});

            var previousUrbanProfitabilityIndex=new Array({name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
            var currentUrbanProfitabilityIndex=new Array({name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
            var previousRuralProfitabilityIndex=new Array({name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
            var currentRuralProfitabilityIndex=new Array({name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
            var ruralStockCover=new Array({name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
            var urbanStockCover=new Array({name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
            var ruralShareOfShoppers=new Array({name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
            var urbanShareOfShoppers=new Array({name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
