var profitsCtrl=function($scope,$http){
    ...
    var initPage=function(){
        ...
        $http({
            ...
            var currentOperatingProfits=new Array({name:'Supplier-1',data:new Array(),color:'#004CE5'},{name:'Supplier-2',data:new Array(),color:'#BB0000'},{name:'Supplier-3',data:new Array(),color:'#FFBC01'},{name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
            var currentOperatingProfitMargins=new Array({name:'Supplier-1',data:new Array(),color:'#004CE5'},{name:'Supplier-2',data:new Array(),color:'#BB0000'},{name:'Supplier-3',data:new Array(),color:'#FFBC01'},{name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
            var currentNetProfits=new Array({name:'Supplier-1',data:new Array(),color:'#004CE5'},{name:'Supplier-2',data:new Array(),color:'#BB0000'},{name:'Supplier-3',data:new Array(),color:'#FFBC01'},{name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
            var currentNetProfitMargins=new Array({name:'Supplier-1',data:new Array(),color:'#004CE5'},{name:'Supplier-2',data:new Array(),color:'#BB0000'},{name:'Supplier-3',data:new Array(),color:'#FFBC01'},{name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
            var previousOperatingProfits=new Array({name:'Supplier-1',data:new Array(),color:'#004CE5'},{name:'Supplier-2',data:new Array(),color:'#BB0000'},{name:'Supplier-3',data:new Array(),color:'#FFBC01'},{name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
            var previousOperatingProfitMargins=new Array({name:'Supplier-1',data:new Array(),color:'#004CE5'},{name:'Supplier-2',data:new Array(),color:'#BB0000'},{name:'Supplier-3',data:new Array(),color:'#FFBC01'},{name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
            var previousNetProfits=new Array({name:'Supplier-1',data:new Array(),color:'#004CE5'},{name:'Supplier-2',data:new Array(),color:'#BB0000'},{name:'Supplier-3',data:new Array(),color:'#FFBC01'},{name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
            var previousNetProfitMargins=new Array({name:'Supplier-1',data:new Array(),color:'#004CE5'},{name:'Supplier-2',data:new Array(),color:'#BB0000'},{name:'Supplier-3',data:new Array(),color:'#FFBC01'},{name:'Retailer-1',data:new Array(),color:'#990099'},{name:'Retailer-2',data:new Array(),color:'#FF5200'});
