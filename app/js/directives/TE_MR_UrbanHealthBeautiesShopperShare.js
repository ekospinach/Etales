define(['directives', 'services'], function(directives) {
    ...
    directives.directive('marketUrbanHealthBeautiesShopperShare', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'StaticValues',
        function(Label, SeminarInfo, $http, PeriodInfo, $q, StaticValues) {
            return {
                ...
                restrict: 'E',
                templateUrl: '../../partials/singleReportTemplate/MR_urbanHealthBeautiesShopperShare.html',
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        loadMarketShopper(data, StaticValues.categoryID.hea, StaticValues.marketID.urban);
