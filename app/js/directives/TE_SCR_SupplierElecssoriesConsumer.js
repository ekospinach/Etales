define(['directives', 'services'], function(directives) {
    directives.directive('supplierElecssoriesConsumer', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'PlayerInfo', 'StaticValues',
        function(Label, SeminarInfo, $http, PeriodInfo, $q, PlayerInfo, StaticValues) {
            return {
                ...
                restrict: 'E',
                templateUrl: 'singleReportTemplate/SCR_supplierElecssoriesConsumer.html',
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        loadConsumer(data, StaticValues.categoryID.ele);
