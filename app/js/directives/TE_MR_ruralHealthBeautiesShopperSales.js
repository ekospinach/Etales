define(['directives', 'services'], function(directives){
    ...
    directives.directive('marketRuralHealthBeautiesShopperSales', ['Label','SeminarInfo','$http','PeriodInfo','$q', function(Label, SeminarInfo, $http, PeriodInfo, $q){
        return {
            scope : {
                isPageShown : '=',
                isPageLoading : '=',
            ...
            restrict : 'E',
            templateUrl : '../../partials/singleReportTemplate/MR_ruralHealthBeautiesShopperSales.html',                        
            link : function(scope, element, attrs){                                                                
                ...
                var organiseArray = function(data){
                    ...
                    loadTotal(data,1,2,2);
                    loadTotal(data,2,2,2);
                    loadTotal(data,3,2,2);
                    loadTotal(data,4,2,2);
