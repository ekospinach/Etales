        ...
        return {
            ...
            link : function(scope, element, attrs){                                                                
                ...
                var getResult =function(){
                    var url='/getMR-suppliersIntelligence/'+SeminarInfo.getSelectedSeminar().seminarCode+'/'+(PeriodInfo.getCurrentPeriod()-1);
                    $http({
                        method:'GET',
                        url:url,
                ...
                var organiseArray = function(data){
                    ...
                    myData.push({
                        ...
                        'UtilizationRate_1e':data.data[0].supplierInfo[0].categoryInfo[0].capacityUtilisationRate*100,
                        'UtilizationRate_2e':data.data[0].supplierInfo[1].categoryInfo[0].capacityUtilisationRate*100,
                        'UtilizationRate_3e':data.data[0].supplierInfo[2].categoryInfo[0].capacityUtilisationRate*100,
                        'UtilizationRate_1h':data.data[0].supplierInfo[0].categoryInfo[1].capacityUtilisationRate*100,
                        'UtilizationRate_2h':data.data[0].supplierInfo[1].categoryInfo[1].capacityUtilisationRate*100,
                        'UtilizationRate_3h':data.data[0].supplierInfo[2].categoryInfo[1].capacityUtilisationRate*100,
