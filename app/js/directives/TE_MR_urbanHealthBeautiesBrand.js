define(['directives', 'services'], function(directives) {
    ...
    directives.directive('marketUrbanHealthBeautiesBrand', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'PlayerColor', 'StaticValues',
        function(Label, SeminarInfo, $http, PeriodInfo, $q, PlayerColor, StaticValues) {
            return {
                ...
                templateUrl: 'singleReportTemplate/MR_urbanHealthBeautiesBrand.html',
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        loadBrandPerceptions(data, StaticValues.categoryID.hea, StaticValues.marketID.urban);
                        deferred.resolve({
                            msg: 'Array is ready.'
                        });
