define(['directives', 'services'], function(directives) {
    ...
    directives.directive('marketBMElecssories', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'StaticValues',
        function(Label, SeminarInfo, $http, PeriodInfo, $q, StaticValues) {
            return {
                ...
                restrict: 'E',
                templateUrl: 'singleReportTemplate/MR_bMElecssories.html',
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        loadRetailerPrice(data, StaticValues.categoryID.ele);
                        deferred.resolve({
                            msg: 'Array is ready.'
                        });
