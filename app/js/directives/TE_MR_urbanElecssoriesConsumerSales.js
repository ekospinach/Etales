define(['directives', 'services'], function(directives) {
    ...
    directives.directive('marketUrbanElecssoriesConsumerSales', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'StaticValues',
        function(Label, SeminarInfo, $http, PeriodInfo, $q, StaticValues) {
            return {
                ...
                restrict: 'E',
                templateUrl: 'singleReportTemplate/MR_urbanElecssoriesConsumerSales.html',
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        loadMarketConsumer(data, StaticValues.categoryID.ele, StaticValues.marketID.urban);
