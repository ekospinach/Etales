define(['directives', 'services'], function(directives) {
    ...
    directives.directive('marketAwarenessElecssories', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'PlayerColor', 'StaticValues',
        ...
        function(Label, SeminarInfo, $http, PeriodInfo, $q, PlayerColor, StaticValues) {
            return {
                ...
                restrict: 'E',
                templateUrl: 'singleReportTemplate/MR_awarenessElecssories.html',
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        scope.increaseRural = [];
                        scope.increaseUrban = [];
                        loadAwareness(data, StaticValues.categoryID.ele, StaticValues.marketID.urban);
                        loadAwareness(data, StaticValues.categoryID.ele, StaticValues.marketID.rural);
                        deferred.resolve({
                            msg: 'Array is ready.'
                        });
