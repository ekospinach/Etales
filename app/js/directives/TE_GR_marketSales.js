            ...
            return {
                ...
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        scope.marketSales2SerihealthBeauty][producer1]],
                            type: "column",
                            color: PlayerColor.getColors()[producer1]
                       }, {
                           "name": Label.getContent('roducer') + ' 2',
                           "data": [scope.totalshealthBeauty][producer2], 0, scope.urbanshealthBeauty][producer2], scope.ruralshealthBeauty][producer2], 0, scope.priceshealthBeauty][producer2], scope.valueshealthBeauty][producer2], scope.fashions[elecssory_Value][producer2], scope.freakss[elecssory_Value][producer2], 0, scope.bms[elecssory_Value][producer2], scope.onlines[elecssory_Value][producer2], scope.mixeds[elecssory_Value][producer2]],
                            type: "column",
                            color: PlayerColor.getColors()[producer2]
                        }, {
                            "name": Label.getContent('Producer') + ' 3',
