define(['directives', 'services'], function(directives) {
    ...
    directives.directive('supplierOnlineBusiness', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'PlayerInfo', '$modal', '$timeout', 'StaticValues',
            ...
            return {
                ...
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        loadTotal(data);
                        loadBusiness(data, StaticValues.categoryID.ele, 1);
                        loadBusiness(data, StaticValues.categoryID.hea, 1);
