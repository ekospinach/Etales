define(['directives', 'services'], function(directives) {
    ...
    directives.directive('marketUrbanHealthBeautiesShopperSales', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'StaticValues',
        function(Label, SeminarInfo, $http, PeriodInfo, $q, StaticValues) {
            return {
                ...
                restrict: 'E',
                templateUrl: 'singleReportTemplate/MR_urbanHealthBeautiesShopperSales.html',
