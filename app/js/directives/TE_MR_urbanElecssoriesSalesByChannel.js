define(['directives', 'services'], function(directives) {
    ...
    directives.directive('marketUrbanElecssoriesSalesByChannel', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'StaticValues',
        function(Label, SeminarInfo, $http, PeriodInfo, $q, StaticValues) {
            return {
                ...
                restrict: 'E',
                templateUrl: '../../partials/singleReportTemplate/MR_urbanElecssoriesSalesByChannel.html',
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        loadChannelSales(data, StaticValues.categoryID.ele, StaticValues.marketID.urban);
