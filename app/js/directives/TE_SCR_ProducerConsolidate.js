define(['directives', 'services'], function(directives){
    ...
    directives.directive('supplierProducerConsolidate', ['Label','SeminarInfo','$http','PeriodInfo','$q','PlayerInfo', function(Label, SeminarInfo, $http, PeriodInfo, $q,PlayerInfo){
        return {
            scope : {
                isPageShown : '=',
                isPageLoading : '='
            ...
            restrict : 'E',
            templateUrl : '../../partials/singleReportTemplate/SCR_producerConsolidate.html',            
