                ...
                var loadConsumer=function(data,category){
                    ...
                    for(var i=0;i<data.data[0].absoluteValue.length;i++){
                        if(data.data[0].absoluteValue[i].parentCategoryID==category){
                            ...
                            priceValueChange=Changes.segmentInfo[0].shopperInfo[3].value;
                            moneyValueChange=Changes.segmentInfo[1].shopperInfo[3].value;
                            fashionValueChange=Changes.segmentInfo[2].shopperInfo[3].value;
                            freaksValueChange=Changes.segmentInfo[3].shopperInfo[3].value;
