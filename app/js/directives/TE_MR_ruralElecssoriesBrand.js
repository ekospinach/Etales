define(['directives', 'services'], function(directives) {
    ...
    directives.directive('marketRuralElecssoriesBrand', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'PlayerColor', 'StaticValues',
        function(Label, SeminarInfo, $http, PeriodInfo, $q, PlayerColor, StaticValues) {
            return {
                ...
                restrict: 'E',
                templateUrl: 'singleReportTemplate/MR_ruralElecssoriesBrand.html',
                ...
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        loadBrandPerceptions(data, StaticValues.categoryID.ele, StaticValues.marketID.rural);
                        deferred.resolve({
                            msg: 'Array is ready.'
                        });
