define(['directives', 'services'], function(directives) {
    ...
    directives.directive('marketUrbanHealthBeautiesSalesByChannel', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'StaticValues',
        function(Label, SeminarInfo, $http, PeriodInfo, $q, StaticValues) {
            return {
                ...
                restrict: 'E',
                templateUrl: 'singleReportTemplate/MR_urbanHealthBeautiesSalesByChannel.html',
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        loadChannelSales(data, StaticValues.categoryID.hea, StaticValues.marketID.urban);
