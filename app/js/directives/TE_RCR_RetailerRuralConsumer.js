                    ...
                    for(var i=0;i<data.data[0].absoluteValue.length;i++){
                        if(data.data[0].absoluteValue[i].parentCategoryID==category&&data.data[0].absoluteValue[i].marketID==market){
                            ...
                            /*
                                ...
                                moneyValueShare=absoluteValue[].segmentInfo[0].shopperInfo[3]
                                fashionValueShare=absoluteValue[].segmentInfo[0].shopperInfo[3]
                                freaksValueShare=absoluteValue[].segmentInfo[0].shopperInfo[3]
                                ...
                                moneyVolumeShare=absoluteVolume[].segmentInfo[0].shopperInfo[3]
                                fashionVolumeShare=absoluteVolume[].segmentInfo[0].shopperInfo[3]
                                freaksVolumeShare=absoluteVolume[].segmentInfo[0].shopperInfo[3]
