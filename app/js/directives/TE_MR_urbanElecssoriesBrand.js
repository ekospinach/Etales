define(['directives', 'services'], function(directives){
    ...
    directives.directive('marketUrbanElecssoriesBrand', ['Label','SeminarInfo','$http','PeriodInfo','$q','PlayerColor', function(Label, SeminarInfo, $http, PeriodInfo, $q, PlayerColor){
        return {
            scope : {
                isPageShown : '=',
                isPageLoading : '=',
            ...
            restrict : 'E',
            templateUrl : '../../partials/singleReportTemplate/MR_urbanElecssoriesBrand.html',            
