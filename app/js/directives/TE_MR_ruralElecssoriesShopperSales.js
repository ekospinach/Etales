define(['directives', 'services'], function(directives) {
    ...
    directives.directive('marketRuralElecssoriesShopperSales', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'StaticValues',
            ...
            return {
                ...
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        loadMarketShopper(data, StaticValues.categoryID.ele, StaticValues.marketID.rural);
