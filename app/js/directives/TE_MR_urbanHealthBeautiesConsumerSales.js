define(['directives', 'services'], function(directives){
    ...
    directives.directive('marketUrbanHealthBeautiesConsumerSales', ['Label','SeminarInfo','$http','PeriodInfo','$q', function(Label, SeminarInfo, $http, PeriodInfo, $q){
        return {
            scope : {
                isPageShown : '=',
                isPageLoading : '=',
            ...
            restrict : 'E',
            templateUrl : '../../partials/singleReportTemplate/MR_urbanHealthBeautiesConsumerSales.html',                        
            link : function(scope, element, attrs){                                                                
                ...
                var loadTotal=function(data,ownerID,category,market){
                    ...
                    if(Values!=undefined){
                        var priceValue=Values.segmentInfo[0].shopperInfo[3].value;
                        var moneyValue=Values.segmentInfo[1].shopperInfo[3].value;
                        var fashionValue=Values.segmentInfo[2].shopperInfo[3].value;
                        var freaksValue=Values.segmentInfo[3].shopperInfo[3].value;
                    }else{
                        var priceValue=0;
                        var moneyValue=0;
                        var fashionValue=0;
                ...
                var loadMarketConsumer=function(data,category,market){
                    for(var i=0;i<data.absoluteValue.length;i++){
                        if(data.absoluteValue[i].parentCategoryID==category&&data.absoluteValue[i].marketID==market){
                            ...
                            var priceValue=data.absoluteValue[i].segmentInfo[0].shopperInfo[3].value;
                            var moneyValue=data.absoluteValue[i].segmentInfo[1].shopperInfo[3].value;
                            var fashionValue=data.absoluteValue[i].segmentInfo[2].shopperInfo[3].value;
                            var freaksValue=data.absoluteValue[i].segmentInfo[3].shopperInfo[3].value;
