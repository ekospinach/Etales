define(['directives', 'services'], function(directives) {
    ...
    directives.directive('marketRuralHealthBeautiesConsumerSales', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'StaticValues',
        function(Label, SeminarInfo, $http, PeriodInfo, $q, StaticValues) {
            return {
                ...
                restrict: 'E',
                templateUrl: 'singleReportTemplate/MR_ruralHealthBeautiesConsumerSales.html',
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        scope.player1s = new Array();
                        scope.player2s = new Array();
                        scope.player3s = new Array();
                        scope.player5s = new Array();
                        scope.player6s = new Array();
                        ...
                        loadMarketConsumer(data, StaticValues.categoryID.hea, StaticValues.marketID.rural);
