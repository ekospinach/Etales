define(['directives', 'services'], function(directives) {
    ...
    directives.directive('marketRuralHealthBeautiesBrand', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'PlayerColor', 'StaticValues',
            ...
            return {
                ...
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        loadBrandPerceptions(data, StaticValues.categoryID.hea, StaticValues.marketID.rural);
                        deferred.resolve({
                            msg: 'Array is ready.'
                        });
