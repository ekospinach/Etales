define(['directives', 'services'], function(directives){
    ...
    directives.directive('marketRuralHealthBeautiesBrand', ['Label','SeminarInfo','$http','PeriodInfo','$q','PlayerColor', function(Label, SeminarInfo, $http, PeriodInfo, $q,PlayerColor){
        return {
            scope : {
                isPageShown : '=',
                isPageLoading : '=',
            ...
            templateUrl : '../../partials/singleReportTemplate/MR_ruralHealthBeautiesBrand.html',            
                    ...
                    for(var i=0;i<data.variantInfo.length;i++){
                        if(category==data.variantInfo[i].parentCategoryID&&market==data.variantInfo[i].marketID){
                            ...
                            switch(data.variantInfo[i].parentCompanyID){
                                ...
                                case 2:scope.quality2s.push([data.variantInfo[i].latestPerception[0],data.variantInfo[i].latestPerception[1],data.variantInfo[i].parentBrandName+data.variantInfo[i].variantName]);scope.price2s.push([2,data.variantInfo[i].latestPerception[2],data.variantInfo[i].parentBrandName+data.variantInfo[i].variantName]);break;
                                case 3:scope.quality3s.push([data.variantInfo[i].latestPerception[0],data.variantInfo[i].latestPerception[1],data.variantInfo[i].parentBrandName+data.variantInfo[i].variantName]);scope.price3s.push([3,data.variantInfo[i].latestPerception[2],data.variantInfo[i].parentBrandName+data.variantInfo[i].variantName]);break;
                                case 5:scope.quality5s.push([data.variantInfo[i].latestPerception[0],data.variantInfo[i].latestPerception[1],data.variantInfo[i].parentBrandName+data.variantInfo[i].variantName]);scope.price5s.push([4,data.variantInfo[i].latestPerception[2],data.variantInfo[i].parentBrandName+data.variantInfo[i].variantName]);break;
                                case 6:scope.quality6s.push([data.variantInfo[i].latestPerception[0],data.variantInfo[i].latestPerception[1],data.variantInfo[i].parentBrandName+data.variantInfo[i].variantName]);scope.price6s.push([5,data.variantInfo[i].latestPerception[2],data.variantInfo[i].parentBrandName+data.variantInfo[i].variantName]);break;
                            }
                        }
                    }
                    scope.mySeries1=[{
