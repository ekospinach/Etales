define(['directives', 'services'], function(directives) {
    ...
    directives.directive('retailerUrbanShopper', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'PlayerInfo', 'StaticValues',
        function(Label, SeminarInfo, $http, PeriodInfo, $q, PlayerInfo, StaticValues) {
            return {
                ...
                restrict: 'E',
                templateUrl: 'singleReportTemplate/RCR_retailerUrbanShopper.html',
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        loadRetailerShooper(data, StaticValues.categoryID.ele, StaticValues.marketID.urban);
                        loadRetailerShooper(data, StaticValues.categoryID.hea, StaticValues.marketID.urban);
