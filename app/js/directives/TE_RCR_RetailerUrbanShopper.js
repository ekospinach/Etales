                ...
                var loadRetailerShooper=function(data,category,market){
                    for(var i=0;i<data.data[0].absoluteValue.length;i++){
                        if(data.data[0].absoluteValue[i].parentCategoryID==category&&data.data[0].absoluteValue[i].marketID==market){
                            ...
                            var bmValueShare=(data.data[0].absoluteValue[i].segmentInfo[4].shopperInfo[0].value.toFixed(2);
                            var onlineValueShare=(data.data[0].absoluteValue[i].segmentInfo[4].shopperInfo[1].value.toFixed(2);
                            var mixedValueShare=(data.data[0].absoluteValue[i].segmentInfo[4].shopperInfo[2].value.toFixed(2);
                            ...
                            var bmValueChange=(valueChanges.segmentInfo[4].shopperInfo[0].value.toFixed(2);
                            var onlineValueChange=(valueChanges.segmentInfo[4].shopperInfo[1].value.toFixed(2);
                            var mixedValueChange=(valueChanges.segmentInfo[4].shopperInfo[2].value.toFixed(2);
                            ...
                            var bmVolumeShare=(Volumes.segmentInfo[4].shopperInfo[0].value.toFixed(2);
                            var onlineVolumeShare=(Volumes.segmentInfo[4].shopperInfo[1].value.toFixed(2);
                            var mixedVolumeShare=(Volumes.segmentInfo[4].shopperInfo[2].value.toFixed(2);
