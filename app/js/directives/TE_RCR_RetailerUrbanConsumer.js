define(['directives', 'services'], function(directives) {
    ...
    directives.directive('retailerUrbanConsumer', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'PlayerInfo', 'StaticValues',
        function(Label, SeminarInfo, $http, PeriodInfo, $q, PlayerInfo, StaticValues) {
            return {
                ...
                restrict: 'E',
                templateUrl: 'singleReportTemplate/RCR_retailerUrbanConsumer.html',
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        loadRetailerConsumer(data,StaticValues.categoryID.ele, StaticValues.marketID.urban);
                        loadRetailerConsumer(data,StaticValues.categoryID.hea, StaticValues.marketID.urban);
