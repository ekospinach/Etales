define(['directives', 'services'], function(directives) {
    ...
    directives.directive('retailerRuralVolume', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'PlayerInfo', 'StaticValues',
        function(Label, SeminarInfo, $http, PeriodInfo, $q, PlayerInfo, StaticValues) {
            return {
                ...
                restrict: 'E',
                templateUrl: 'singleReportTemplate/RCR_retailerRuralVolume.html',
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        loadretailerVolume(data, StaticValues.categoryID.ele, StaticValues.marketID.rural);
                        loadretailerVolume(data, StaticValues.categoryID.hea, StaticValues.marketID.rural);
