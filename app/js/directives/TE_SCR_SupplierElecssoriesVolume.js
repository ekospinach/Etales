define(['directives', 'services'], function(directives) {
    directives.directive('supplierElecssoriesVolume', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'PlayerInfo', 'StaticValues',
        function(Label, SeminarInfo, $http, PeriodInfo, $q, PlayerInfo, StaticValues) {
            return {
                ...
                restrict: 'E',
                templateUrl: 'singleReportTemplate/SCR_supplierElecssoriesVolume.html',
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        loadVolume(data, StaticValues.categoryID.ele);
                        scope.urbanProducts     = [];
                        scope.ruralProducts     = [];
                        scope.urbanProductNames = [];
                        scope.ruralProductNames = [];
                        loadMarketVolume(data, StaticValues.categoryID.ele, StaticValues.marketID.urban);
                        loadMarketVolume(data, StaticValues.categoryID.ele, StaticValues.marketID.rural);
                        deferred.resolve({
                            msg: 'Array is ready.'
                        });
