define(['directives', 'services'], function(directives) {
    ...
    directives.directive('marketRuralHealthBeautiesSalesByChannel', ['Label', 'SeminarInfo', '$http', 'PeriodInfo', '$q', 'StaticValues',
            ...
            return {
                ...
                link: function(scope, element, attrs) {
                    ...
                    var organiseArray = function(data) {
                        ...
                        loadChannelSales(data, StaticValues.categoryID.hea, StaticValues.marketID.rural);
