define(['directives', 'services'], function(directives){
    ...
    directives.directive('marketRuralHealthBeautiesSalesByChannel', ['Label','SeminarInfo','$http','PeriodInfo','$q', function(Label, SeminarInfo, $http, PeriodInfo, $q){
        return {
            scope : {
                isPageShown : '=',
                isPageLoading : '=',
            ...
            restrict : 'E',
            templateUrl : '../../partials/singleReportTemplate/MR_ruralHealthBeautiesSalesByChannel.html',                        
