var getLabelBase = function(){
	return [
		...
		{id:'Profitability by Supplier',  ENG:'Profitability by Supplier',  CHN:'品类在各渠道的盈利分析',  RUS:''},
		...
		{id:'Volume Discounts',  ENG:'Volume Discounts',  CHN:'销量折扣',  RUS:''},
		...
		{id:'B&M List Prices',  ENG:'B&M List Prices',  CHN:'实体店价格',  RUS:''},
		{id:'B&M List Prices Pop Info',  ENG:'list price for bricks&mortar trade in current period',  CHN:'当阶段实体店价格列表',  RUS:''},
		...
		{id:'Target Volume Info',  ENG:'is the minimum quantity of SKU that retailers need to sell to avail performance bonus. Performance Bonus = (Quantities of an SKU sold - Target Volume)*List Price*Bonus Rate, provided that Quantities of an SKU sold by retailer is greater than the target volume',  CHN:'零售商需要完成的目标销量；业绩红利=（实际销量-目标销量）*单品价格*红利率',  RUS:''},
		{id:'Bonus Rate',  ENG:'Bonus Rate',  CHN:'红利率',  RUS:''},
		{id:'Bonus Rate Info',  ENG:'is the bonus rate that retailers will enjoy if they sell more than the target volume. Performance Bonus = (Quantities of an SKU sold - Target Volume)*List Price*Bonus Rate, provided that Quantities of an SKU sold by retailer is greater than the target volume',  CHN:'零售商销售情况高于目标销量，将会获得红利',  RUS:''},
		{id:'Payment Terms',  ENG:'Payment Terms',  CHN:'付款条件',  RUS:''},
		{id:'Payment Terms Info',  ENG:'is the number of days within which the retailer needs to pay for the products ordered from the suppliers. It is same the days within which Accounts Receivable for the supplier is converted into Cash.',  CHN:'付款期限是指零售商需要支付给供应商货款的期限。同时也是指供应商应收账款到账的期限',  RUS:''},
		{id:'Other Compensation',  ENG:'Other Compensation',  CHN:'其他补贴',  RUS:''},
		{id:'Other Compensation Info',  ENG:"is the miscellaneous compensation agreements between Supplier and Retailers. If in a negotiation, a supplier agrees to pay for a retailer's MR, the 'other compensation' will be used to transfer from supplier to retailer and register transaction as a 'trade investment' with the supplier",  CHN:'其它补贴是指供应商和零售商之间的补贴条款。谈判中，若供应商同意支付零售商的市场调查费用，那么“其它补贴”将会从供应商转至零售商，该行为视作供应商的“商业投资”',  RUS:''},
		...
		{id:'Production Volume Info',  ENG:'is the number of million units of an SKU to be produced by a Supplier or a Private Label Retailer',  CHN:'百万包单品将由供应商或是自有品牌零售商生产?',  RUS:''},
		/*supplier Negotiation end*/
		/*supplier general marketing start*/
		{id:'Advertising Online',  ENG:'Advertising Online',  CHN:'网络广告',  RUS:''},
		{id:'Advertising Online Info',  ENG:'budget you spend to advertise your brands through online means on a national scale',  CHN:'在大规模宣传品牌上控制预算',  RUS:''},
		{id:'Advertising Offline',  ENG:'Advertising Offline',  CHN:'线下广告',  RUS:''},
		...
		{id:'Traditional Trade Support Rural Info',  ENG:'budget you invest to support of Traditional Trade in Rural market; it increases visibility of your brands at Traditional Trade.',  CHN:'在农村市场投资传统渠道；在传统渠道上增加品牌可见度',  RUS:''},
		{id:'Traditional Trade Support Urban Info',  ENG:'budget you invest to support of Traditional Trade in Urban market; it increases visibility of your brands at Traditional Trade.',  CHN:'在城市市场投资传统渠道；在传统渠道上增加品牌可见度',  RUS:''},
		/*supplier general marketing end*/
		/*supplier Online Store Management start*/
		{id:'Visibility',  ENG:'Visibility',  CHN:'可见度',  RUS:''},
		{id:'Visibility Info',  ENG:'budget you invest in online activities such as purchasing ad-words to make the brand more visible for online shoppers. It is decided at the brand level.',  CHN:'投资线上活动，比如购买广告字段，让更多线上购物者看到品牌。在品牌层级做出决策' ,  RUS:''},
		{id:'Online Planned Volumes',  ENG:'Online Planned Volumes',  CHN:'订单量',  RUS:''},
		{id:'Online Planned Volumes Info',  ENG:'is the number of million units of an SKU that a Supplier decides to cater for the eMall (online channel)',  CHN:'由供应商决定百万包单品数量，以吸引电子商城（线上渠道）',  RUS:''},

		{id:'Prices',  ENG:'Prices',  CHN:'价格',  RUS:''},
		{id:'Prices Info',  ENG:'is the online retail price of the SKU that a Supplier decides to cater for the eMall (online channel)',  CHN:'由供应商决定每支单品线上零售价，以吸引电子商城（线上渠道）',  RUS:''},
		{id:'Promotions Frequency',  ENG:'Promotions Frequency',  CHN:'促销频率',  RUS:''},
		{id:'Promotions Frequency Info',  ENG:'is the number of days out of 26 weeks in each period when you plan to make your promotion campaign effective.',  CHN:'当决定有效进行促销活动时，选择26周中需要促销的周数',  RUS:''},
		{id:'Promotions Depth',  ENG:'Promotions Depth',  CHN:'促销力度',  RUS:''},
		{id:'Promotions Depth Info',  ENG:'is discount percent off normal online retail price effective during promotions.is discount percent off normal online retail price effective during promotions.',  CHN:'促销折扣',  RUS:''},
		/*supplier Online Store Management end*/
		/*supplier Asset Investments start*/
		{id:'Capacity',  ENG:'Capacity',  CHN:'能力',  RUS:''},
		{id:'Capacity Info',  ENG:'to extend your capacity you have to invest a period before it gets ready; current period extension is also possible but at 50% higher charge; your capacity increases your fixed assets and labor cost; you cannot sell out or lease your capacity to other players.',  CHN:'为了扩大产能，必须在上一阶段进行产能投资。当阶段产能扩大成本为额外支付50%。产能增长能扩大资产并减少生产成本；产能无法销售或是出租给竞争对手',  RUS:''},
		{id:'Technology',  ENG:'Technology',  CHN:'技术',  RUS:''},
		{id:'Flexibility',  ENG:'Flexibility',  CHN:'灵活性',  RUS:''},
		{id:'Design',  ENG:'Design',  CHN:'设计',  RUS:''},
		{id:'Technology Info',  ENG:'applies to both categories; you start with level 7 and can increase it to 20 by the session end; increases your fixed assets.',  CHN:'技术可应用于所有品类；初始阶段技术水平为7，至课程末，最高可投资增长至20；技术投入等价于增加固定资产',  RUS:''},
		{id:'Flexibility Info',  ENG:'applies to both categories; helps you to automatically adjust your production to correspond to orders placed by retailers; affects your fixed assets.',  CHN:'灵活性适用于所有品类，帮助自动调整产能，以适应零售商的预订订单量；灵活性会影响固定资产',  RUS:''},
		{id:'Design Info',  ENG:'Health/Beauties; you start with level 7 and can increase it to 20 by the session end; increases your fixed assets.',  CHN:'美容保健品类；初始阶段为7，至课程末，最高可投资增长至20；设计投入等价于增加固定资产',  RUS:''},
		...
		{id:'pre',  ENG:'pre',  CHN:'',  RUS:'···之前'},
		{id:'late',  ENG:'last',  CHN:'',  RUS:'最后'},
		...
		{id:'Delivered Volume',  ENG:'Delivered Volume',  CHN:'实际出货量',  RUS:''},
		...
		{id:'Net Profit Margins',  ENG:'Net Profit Margins',  CHN:'净利润率',  RUS:''},
		...
		{id:'Estimated Period Spending',  ENG:'Estimated Period Spending',  CHN:'当阶段预计支出费用',  RUS:''},
		...
		{id:'Operating Profits',  ENG:'Operating Profits',  CHN:'运营利润',  RUS:''},
		{id:'Sales by Channel',  ENG:'Sales by Channel',  CHN:'渠道销售',  RUS:''},
		{id:'Channel Preference',  ENG:'Channel Preference',  CHN:'渠道偏好',  RUS:''},
		{id:'Channel Preference Info',  ENG:'0% means full preference for off-line shipments (B&M retailers) and 100% is for full preference for on-line sales. Anything between, will make a proportional effect. ',  CHN:'0%指完全偏好线下（实体店）递送方式；100%是指完全偏好线上销售。介于两者之间的，按一定比例分配。',  RUS:''},		
		{id:'eMall Commission',  ENG:'eMall Commission',  CHN:'eMall Commission电子商城佣金',  RUS:''},
		{id:'Shipping Cost',  ENG:'Shipping Cost',  CHN:'递送成本',  RUS:''},		
