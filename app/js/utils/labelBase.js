var getLabelBase = function(){
	return [
		...
		{id:'-Local Tier T ($mln)',  ENG:'-Local Tier T ($mln)',  CHN:'',  RUS:''},
		{id:'-Stores Operating Costs ($mln)',  ENG:'-Stores Operating Costs ($mln)',  CHN:'',  RUS:''},
		{id:'-Amortisation ($mln)',  ENG:'-Amortisation ($mln)',  CHN:'',  RUS:''},
		/*homepage*/
		{id:'eTales Info',  ENG:'Best-in-class professional development tool among the world’s most respected companies and leading business schools',  CHN:'',  RUS:''},
		{id:'Get started',  ENG:'Get started',  CHN:'',  RUS:''},
		{id:'Admin entrance',  ENG:'Admin entrance',  CHN:'',  RUS:''},
		{id:'Currently',  ENG:'Currently',  CHN:'',  RUS:''},
		{id:'User Login',  ENG:'User Login',  CHN:'',  RUS:''},	
		{id:'Role',  ENG:'Role',  CHN:'',  RUS:''},	
		{id:'Password',  ENG:'Password',  CHN:'',  RUS:''},	
		{id:'Seminar Code',  ENG:'Seminar Code',  CHN:'',  RUS:''},	
		{id:'Login',  ENG:'Login',  CHN:'',  RUS:''},	
		{id:'Admin Login',  ENG:'Admin Login',  CHN:'',  RUS:''},	
		{id:'Facilitator',  ENG:'Facilitator',  CHN:'',  RUS:''},	
		{id:'',  ENG:'',  CHN:'',  RUS:''},	
		{id:'',  ENG:'',  CHN:'',  RUS:''},	
		{id:'',  ENG:'',  CHN:'',  RUS:''},	
		{id:'',  ENG:'',  CHN:'',  RUS:''},	
		...
		{id:'Sales value (RMB 000)',  ENG:'Sales value (RMB 000)',  CHN:'销售额(以千为单位)',  RUS:''},
		...
		{id:'Purchases',  ENG:'Purchases',  CHN:'采购',  RUS:''},
		/*market report-table*/
		...
		{id:'Profitability by Channel',  ENG:'Profitability by Channel',  CHN:'渠道盈利',  RUS:''},
		{id:'Profitability by Channel Info',  ENG:'Profitability by Channel Info',  CHN:'渠道盈利信息',  RUS:''},
		...
		{id:'Profitability by Supplier',  ENG:'Profitability by Supplier',  CHN:'供应商赢利',  RUS:''},
		...
		{id:'Contract List',  ENG:'Contract List',  CHN:'合同清单',  RUS:''},
		...
		{id:'Items (Producer Input)',  ENG:'Items (Producer Input)',  CHN:'项目（生产商输入）',  RUS:''},
		{id:'Items (Retailer Input)',  ENG:'Items (Retailer Input)',  CHN:'项目（零售商输入）',  RUS:''},
		...
		{id:'Copy from peer proposal',  ENG:'Copy from peer proposal',  CHN:'复制其他产品协议提案',  RUS:''},
		...
		{id:'Products portfolio Info',  ENG:'Step 1 of 4, determine your products portfolio, i.e. brand names, variant(s) of each brand with their respective name(s) and product composition or product specification, including packaging format.',  CHN:'第一步:决定你的产品组合，如品牌名称、配方、包装等',  RUS:''},
		{id:'Step 1 of 4',  ENG:'Step 1 of 4',  CHN:'第一步（共四步)',  RUS:''},
		...
		{id:'Smoothener Level',  ENG:'Smoothener Level',  CHN:'光滑因子水平',  RUS:''},
		...
		{id:'Acquired Technology Level',  ENG:'Acquired Technology Level',  CHN:'拥有的技术水平',  RUS:''},
		{id:'Acquired Design Level',  ENG:'Acquired Design Level',  CHN:'拥有的设计水平',  RUS:''},
		...
		{id:'Production and pricing Info',  ENG:'Step 2 of 4, after you have finalized you product portfolio for coming period, you should tell the system volumes to be produced this period and wholesale prices for next period',  CHN:'第二步(共四步)，确定完产品组合后,你需要确定本阶段的产量，并为下阶段制订价格',  RUS:''},
		...
		{id:'Step 2 of 4',  ENG:'Step 2 of 4',  CHN:'第二步（共四步)',  RUS:''},
		...
		{id:'Producer Advertising Info',  ENG:'Step 3 of 4, After setting production volumes and future wholesale prices you need to take some marketing decisions both market related and national.',  CHN:'第三步(共四步)：现在你需要制订广告决策,　包括全国市场和本地市场',  RUS:''},
		{id:'Step 3 of 4',  ENG:'Step 3 of 4',  CHN:'第三步(共四步)',  RUS:''},
		...
		{id:'Category Decision Info',  ENG:'Step 4 of 4, At last you have to make decisions influencing whole category. These decisions are long-term investments, that is why they are not taken from your limited operational budget, you borrow these investments from capital market at a cost. Keep in mind that your long-term investments increase your fixed assets and consequently costs of running business. ',  CHN:'第四步（最后一步)，制订品类层面的决策，这属于公司长期决策，这部分投资不占用你有限的运营预算,而是以一定成本从资本市场获得,请注意长期投资会增加你的固定资产,　最终会增加你的运营资本.',  RUS:''},
		{id:'Step 4 of 4',  ENG:'Step 4 of 4',  CHN:'第四步(最后一步)',  RUS:''},
		...
		{id:'Market Info',  ENG:'Step 2 of 4, After completing national set of decisions, it would be logical to work on the decisions specific for each of the markets. They will be of a strategic essence and influence your store chain positioning on the market. ',  CHN:'第二步（共四步):制订本地市场的决策，这将影响门店在当地市场的定位。',  RUS:''},
		...
		{id:'Private Labels Composition Info',  ENG:'Step 3 of 4, At this step you have to think about and take your decision on the portfolio of your private labels. You start with one PL per category per market. You may have three PLs per category per market.',  CHN:'第三步(共四步)，制订你的自有品牌组合决策.你在开始阶段每个市场每个品类各有一个自有品牌,　最多可以在每个市场每个品类各拥有三个自有品牌.',  RUS:''},
		{id:'Unit Production Cost',  ENG:'Unit Production Cost',  CHN:'单位生产成本',  RUS:''},
		/*retailer step 4*/
		{id:'Order Pricing Shelf',  ENG:'Order, Pricing and Shelf Allocation',  CHN:'订货、定价和货架分配',  RUS:''},
		{id:'Order Pricing Shelf Info',  ENG:'Step 4 of 4, placing orders with suppliers, allocating shelf space, setting retail price and defining promotions for each brand (both supplier and private label) at each market.',  CHN:'第四步(最后一步)，确定向生产商的定货量,制订零售价，分市场、按品类为每个单品（包括生产商和你的自有品牌)分配货架空间,制订促销计划',  RUS:''},
		{id:'Available ShelfSpace',  ENG:'Available ShelfSpace',  CHN:'可分配的货架空间',  RUS:''},
		{id:'Private Label',  ENG:'Private Label',  CHN:'自有品牌',  RUS:''},
		{id:'List Price',  ENG:'List Price',  CHN:'零售价',  RUS:''},
