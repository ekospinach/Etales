var getLabelBase = function(){
	return [
		...
		{id:'Negotiation Agreements',  ENG:'Negotiation Agreements',  CHN:'',  RUS:''},



		{id:'Volume Discounts',  ENG:'Volume Discounts',  CHN:'数量折扣',  RUS:''},
		{id:'Volume Discounts Info',  ENG:'is the minimum quantity of an SKU that retailers need to order to avail volume discount. Discount Amount for an SKU = Order Quantity (>Minimum Order Quantity) * Discount Rate% * List Price for the SKU',  CHN:'数量折扣介绍',  RUS:''},
		...
		{id:'Wait P1',  ENG:'Waiting for Supplier 1 to commit portfolio decision',  CHN:'等待生厂商1提交决策',  RUS:''},
		{id:'Wait P2',  ENG:'Waiting for Supplier 2 to commit portfolio decision',  CHN:'等待生厂商2提交决策',  RUS:''},
		{id:'Wait P3',  ENG:'Waiting for Supplier 3 to commit portfolio decision',  CHN:'等待生厂商3提交决策',  RUS:''},
		...
		{id:'Effectiveness of Trade Spending Info',  ENG:'Return on investment (ROI) of trade support spending',  CHN:'',  RUS:''},
		{id:'Effectiveness of Marketing Spending Info',  ENG:'Return on investment (ROI) of marketing spending',  CHN:'',  RUS:''},
		{id:'Portfolio Strength Info',  ENG:'Average awareness across SKUs in the category',  CHN:'',  RUS:''},
		{id:'Channel Strength Info',  ENG:'Share of sales and share of shoppers through the respective channel',  CHN:'',  RUS:''},
		...
		{id:'Bonus Rate Info',  ENG:'is the bonus rate that retailers will enjoy if they sell more than the target volume. Performance Bonus = (Quantities of an SKU sold - Target Volume)*List Price*Bonus Rate, provided that Quantities of an SKU sold by retailer is greater than the target volume',  CHN:'红利率',  RUS:''},
		{id:'Payment Terms',  ENG:'Payment Terms',  CHN:'付款条件',  RUS:''},
		{id:'Payment Terms Info',  ENG:'is the number of days within which the retailer needs to pay for the products ordered from the suppliers. It is same the days within which Accounts Receivable for the supplier is converted into Cash.',  CHN:'付款条件',  RUS:''},
		...
		{id:'Traditional Trade Support Rural Info',  ENG:'budget you invest to support of Traditional Trade in Rural market; it increases visibility of your brands at Traditional Trade.',  CHN:'传统渠道支持',  RUS:''},
		{id:'Traditional Trade Support Urban Info',  ENG:'budget you invest to support of Traditional Trade in Urban market; it increases visibility of your brands at Traditional Trade.',  CHN:'传统渠道支持',  RUS:''},
		...
		{id:'Capacity Info',  ENG:'to extend your capacity you have to invest a period before it gets ready; current period extension is also possible but at 50% higher charge; your capacity increases your fixed assets and labor cost; you cannot sell out or lease your capacity to other players.',  CHN:'能力',  RUS:''},
		{id:'Technology',  ENG:'Technology',  CHN:'技术',  RUS:''},
		{id:'Flexibility',  ENG:'Flexibility',  CHN:'灵活性',  RUS:''},
		{id:'Design',  ENG:'Design',  CHN:'设计',  RUS:''},
		{id:'Technology Info',  ENG:'applies to both categories; you start with level 7 and can increase it to 20 by the session end; increases your fixed assets.',  CHN:'技术',  RUS:''},
		...
		{id:'Supplier does not have enough budget.',  ENG:'Supplier does not have enough budget.',  CHN:'Supplier does not have enough budget.',  RUS:''},
		...
		{id:'Program Code',  ENG:'Program Code',  CHN:'课程编码',  RUS:''},
