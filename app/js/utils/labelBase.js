var getLabelBase = function(){
	return [
		...
		{id:'Total Trade (Producer) Support',  ENG:'Total Trade (Producer) Support',  CHN:'（生产商）渠道支持合计',  RUS:''},	
		...
		{id:'Total Trade (Producer) Support Info',  ENG:'Total Trade (Producer) Support Info',  CHN:'Total Trade (Producer) Support Info',  RUS:''},	
