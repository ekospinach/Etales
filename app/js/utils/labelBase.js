var getLabelBase = function(){
	return [
		...
		{id:'Gentleness',  ENG:"Gentleness",  CHN:'亲柔度感知',  RUS:''},
		...
		{id:'Total across Categories & Market',  ENG:'Total across Categories & Market',  CHN:'市场和品类总计',  RUS:''},
		...
		{id:'Value of Performance Bonus ($mln)',  ENG:'Value of Performance Bonus ($mln)',  CHN:'销售业绩奖励',  RUS:''},
		{id:'-Discontinued Goods Cost($mln)',  ENG:'Discontinued Goods Cost($mln)',  CHN:'停售商品成本',  RUS:''},
		{id:'-Inventory Holding Cost($mln)',  ENG:'Inventory Holding Cost($mln)',  CHN:'库存持有成本',  RUS:''},
		{id:'-General Expenses($mln)',  ENG:'General Expenses($mln)',  CHN:'一般性费用',  RUS:''},
		{id:'-Taxes($mln)',  ENG:'Taxes($mln)',  CHN:'所得税',  RUS:''},
		{id:'Value Rotation Index  Sales value per sqm of shelf space',  ENG:'Value Rotation Index Sales value per sqm of shelf space',  CHN:'每平方米店面的销售额',  RUS:''},
		{id:'Volume Rotation Index  Sales volume per sqm of shelf space',  ENG:'Volume Rotation Index Sales volume per sqm of shelf space',  CHN:'每平方米店面的销量',  RUS:''},
		{id:'Profitability Index  Gross Profit per sqm of shelf space',  ENG:'Profitability Index Gross Profit per sqm of shelf space',  CHN:'每平方米店面的毛利额',  RUS:''},
		...
		{id:'B&M Retailer Prices',  ENG:'Retailer Prices',  CHN:'实体店零售价格',  RUS:''},
		...
		{id:'Increased Capacity',  ENG:'Increased Capacity',  CHN:'提升可用产能',  RUS:''},
		...
		{id:'Rotation Index Info',  ENG:'sales (volume and value) per sqm shelf space',  CHN:'每平方米店面产生的销售（销量和销售额）',  RUS:''},
		{id:'Profitability Index Info',  ENG:'net profit per sqm shelf space',  CHN:'每平方米店面产生的净利润',  RUS:''},
		...
		{id:'Payment Terms',  ENG:'Payment Terms',  CHN:'账期',  RUS:''},
		...
		{id:'Retailer Promotions Depth Info',  ENG:'is the discount percent off normal retail price effective during promotions.',  CHN:'基于正常价格的促销折扣率。',  RUS:''},
		...
		{id:'You are checking the Confidential Report of period',  ENG:'You are checking the Confidential Report of period ',  CHN:'你正在查看公司报告，阶段 ',  RUS:''},
		...
		*/
		...
		{id:'Make negotiation decisions with Suppliers',  ENG:'Make negotiation decisions with Suppliers',  CHN:'Make negotiation decisions with Suppliers',  RUS:''},		
		...
		{id:'Finalise negotiation decisions with Suppliers',  ENG:'Finalise negotiation decisions with Suppliers',  CHN:'Finalise negotiation decisions with Suppliers',  RUS:''},		
		...
		{id:'THE END',  ENG:'THE END',  CHN:'结束',  RUS:''},
		{id:'Negotiation Results',  ENG:'Negotiation Results',  CHN:'谈判结果',  RUS:''},
		{id:'Total Volume Discounts',  ENG:'Total Volume Discounts',  CHN:'销量总折扣',  RUS:''},
		{id:'Total Performance Bonuses',  ENG:'Total Performance Bonuses',  CHN:'业绩总奖励',  RUS:''},
		{id:'Total Transaction Value of Other Compensation',  ENG:'Total Transaction Value of Other Compensation',  CHN:'交易总额的其他补贴',  RUS:''},
		{id:'Current',  ENG:'Current',  CHN:'当前阶段',  RUS:''},
		{id:'Previous',  ENG:'Previous',  CHN:'上阶段',  RUS:''},
		{id:'Supplier KPIs',  ENG:'Supplier KPIs',  CHN:'生产商关键绩效指标',  RUS:''},
		{id:'Retailer KPIs',  ENG:'Retailer KPIs',  CHN:'零售商关键绩效指标',  RUS:''},
		{id:'B&M Channel Strength',  ENG:'B&M Channel Strength',  CHN:'实体店渠道竞争力',  RUS:''},
		{id:'Online Channel Strength',  ENG:'Online Channel Strength',  CHN:'线上渠道竞争力',  RUS:''},
		{id:'Final Score',  ENG:'Final Score',  CHN:'最终得分',  RUS:''},
		{id:'Supplier Scores',  ENG:'Supplier Scores',  CHN:'生厂商得分',  RUS:''},
		{id:'Retailer Scores',  ENG:'Retailer Scores',  CHN:'零售商得分',  RUS:''},
		{id:'Incremental market Share',  ENG:'Incremental market Share (IMS)',  CHN:'增量市场份额',  RUS:''},
		{id:'Return on Operational Budget',  ENG:'Return on Operational Budget (ROOB)',  CHN:'回报经营预算',  RUS:''},
		{id:'Final Portfolio Strength',  ENG:'Portfolio Strength (PS)',  CHN:'产品组合的竞争力',  RUS:''},
		{id:'Final Channel Strength',  ENG:'Channel Strength (CS)',  CHN:'渠道竞争力',  RUS:''},
		...
		{id:'Available Inventory(including production +/- internal transfers)',  ENG:'Available Inventory(including production +/- internal transfers)',  CHN:'根据设定的\"渠道偏好\"以及当期产量重新调整后的库存',  RUS:''},
		{id:'Shipped to Retailers',  ENG:'Shipped to Retailers',  CHN:'线下销量（到零售商）',  RUS:''},
		{id:'Sold Online',  ENG:'Sold Online',  CHN:'线上销量',  RUS:''},
		{id:'Service Cost',  ENG:'Service Cost',  CHN:'服务成本',  RUS:''},
		...
		{id:'check PromototionFrequency Error',  ENG:'Promotion Frequency cannot be zero',  CHN:'促销频率不能为零',  RUS:''},
		{id:'check ReductionRate Error',  ENG:'Promotion Depth Cannot be zero',  CHN:'折扣率不能为零',  RUS:''},
