...
//    WriteLn('</H2>');
    ...
    if sValue='GET' then
      begin
        // GET
//3.Company History Information CGI
//Action : GET
//Parameters: period, seminar
//Route example: …/brandHistoryInfo?period=1&seminar=MAY
//Schema: brandHistoryInfo.js
//Response:
//status code 200, JSON record”S" which is defined in related schema, including all the companies which meets the specified parameters(seminar/period)
