program RCR_sharesCrossSegment;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            tempVariant := currentResult.r_RetailersConfidentialReports[currentRetailer].rcr_SharesByCrossSegment[ marketID,catID, brandCount, variantCount];
